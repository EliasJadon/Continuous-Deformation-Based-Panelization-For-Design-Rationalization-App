...
double AuxCylinder2::value(Cuda::Array<double>& curr_x, const bool update)
{	
	double value = 0;
...
void AuxCylinder2::gradient(Cuda::Array<double>& X, const bool update)
{
